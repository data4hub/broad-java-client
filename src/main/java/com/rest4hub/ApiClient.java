...
import com.rest4hub.auth.Authentication;
import com.rest4hub.auth.HttpBasicAuth;
import com.rest4hub.auth.ApiKeyAuth;
import com.rest4hub.auth.OAuth;

public class ApiClient {
  private Map<String, Client> hostMap = new HashMap<String, Client>();
  private Map<String, String> defaultHeaderMap = new HashMap<String, String>();
  private boolean debugging = false;
  private String basePath = "http://localhost:8002/api";
